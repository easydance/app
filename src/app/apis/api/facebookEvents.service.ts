...
export class FacebookEventsService implements FacebookEventsServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createMany(createFacebookEventsRequestDto: Array<CreateFacebookEventsRequestDto>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any>;
    public createMany(createFacebookEventsRequestDto: Array<CreateFacebookEventsRequestDto>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpResponse<any>>;
    public createMany(createFacebookEventsRequestDto: Array<CreateFacebookEventsRequestDto>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpEvent<any>>;
    public createMany(createFacebookEventsRequestDto: Array<CreateFacebookEventsRequestDto>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
        if (createFacebookEventsRequestDto === null || createFacebookEventsRequestDto === undefined) {
